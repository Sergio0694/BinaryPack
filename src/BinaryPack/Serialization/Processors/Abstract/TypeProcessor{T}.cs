...
namespace BinaryPack.Serialization.Processors.Abstract
{
    ...
    internal abstract class TypeProcessor<T>
    {
        ...
        /// </summary>
        public readonly DynamicMethod<BinarySerializer<T>> SerializerInfo = DynamicMethod<BinarySerializer<T>>.New();

        /// <summary>
        /// The <see cref="DynamicMethod{T}"/> instance holding the deserializer being built for items of type <typeparamref name="T"/>
        /// </summary>
        public readonly DynamicMethod<BinaryDeserializer<T>> DeserializerInfo = DynamicMethod<BinaryDeserializer<T>>.New();
